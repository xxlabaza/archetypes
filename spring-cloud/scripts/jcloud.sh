...
VERSION="1.0.0"
PACKAGE=""
SPRING_BOOT_VERSION="2.1.12.RELEASE"
SPRING_CLOUD_VERSION="Greenwich.SR5"
INTERACTIVE="NO"
DEBUG="NO"
...
function print_debug_info () {
  ...
  echo SPRING_CLOUD_VERSION = "${SPRING_CLOUD_VERSION}"
...
mvn archetype:generate \
    ...
    -Dspring-cloud=${SPRING_CLOUD_VERSION}
