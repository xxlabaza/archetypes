...
class MockitoTests {
  ...
  @Test
  void checkSpringBootIntegration (@Mock List<String> list) {
    assertNotNull(environment);

    int value = environment.getProperty("variable.value", Integer.class);
  ...
  class InjectMocksAnnotation {
    ...
    class MyDictionary {
      ...
      void add (final String word, final String meaning) {
